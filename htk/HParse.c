...
int mainHParse(int argc, char *argv[])
{
	static int ft=1;
...
{
	trace     = 0;         /* Trace flags */
	numWdBegin=0;              /* number of WORD_BEGIN nodes */
	numWdEnd=0;                /* number of WORD_END nodes */
	v1Compat=FALSE;        /* compatability mode? */
	saveLatLM=FALSE;       /* output lattice probabilities */
	saveLatBin=FALSE;      /* save lattice in binary */ 
	nParm = 0;            /* total num params */
	numLinkSets = 0;     /* usage counters */
	numLinks = 0;
	numNodes = 0;
}
/* ------------------- End of HParse.c --------------------------------- */
